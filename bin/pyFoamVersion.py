...
# hardcodedVersion=(2023, 7, 99) # Change in src/PyFoam/__init__.py as well
hardcodedVersion=(2023, 7)  # Release version
...
testLibrary("IPython",
            ...
            minVersion="2.0.0")
testLibrary("jinja2", "Not necessary. But could be used as an alternate templating engine")
