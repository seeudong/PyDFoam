...
class FoamLogAnalyzer(object):
        ...
        for k,v in iteritems(data):
            ...
            if isinstance(v,(dict,)):
                ...
                if not isDicts:
                    ...
                    wFormat="{:%d} : {:8g}" % maxLen
                    chunks=[wFormat.format(k1,v[k1]) for k1 in v.keys()]
                    ...
                    chunkLen=0
                    for k1,v1 in iteritems(v):
                        chunks[k1]=[wFormat.format(k2,v1[k2]) for k2 in v1.keys()]
    ...
    def analyze(self,fh):
        ...
        while(self.reader.read(fh)):
            self.analyzeLine(self.reader.line)
