...
variables
    ...
    def addOptions(self):
        ...
        pickleGroup=OptionGroup(self.parser,
                                "Write pickled plot data",
                                "Whether pickled plot data is to be written")
        pickleGroup.add_option("--no-pickled-file",
                               action="store_false",
                               default=True,
                               dest="writePickled",
                               help="Do not write a pickled file with the plot data")
        self.parser.add_option_group(pickleGroup)
